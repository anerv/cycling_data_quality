...
import argparse
parser = argparse.ArgumentParser(description='Export executed notebooks to PDF.', formatter_class=argparse.RawTextHelpFormatter)
...
args = ["gs", "-q", "-dNOPAUSE", "-dBATCH", "-dPDFSETTINGS=/prepress", "-sDEVICE=pdfwrite", "-sOutputFile="+iopath+"report.pdf", iopath+"titlepage.pdf"]
...
tempfiles = ["titlepage.html", "titlepage.pdf", "titleimage.svg",
"footer_template.html", "header_template.html", 
"preamble.html", "preambletemp.html", "preamble.pdf", 
"1a.html", "1atemp.html", "1b.html", "1btemp.html", 
"2a.html", "2atemp.html", "2b.html", "2btemp.html",
"3a.html", "3atemp.html", "3b.html", "3btemp.html",
"appendix_a.html", "appendix_atemp.html", "appendix_a.pdf"]
for t in tempfiles:
    try:
        os.remove(iopath+t)
    except OSError:
