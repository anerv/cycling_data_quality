...
assert len(bicycle_nodes_simplified) == len(bicycle_nodes_simplified.reset_index().osmid.unique())
...
bicycle_edges_simplified['osmid'] = bicycle_edges_simplified[
    'osmid'
].astype(str)
...
osm_edges_simp_joined['osmid'] = osm_edges_simp_joined[
    'osmid'
].astype(str)
