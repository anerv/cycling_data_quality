...
ref_nodes_simp_joined.to_file(ref_nodes_simplified_joined_fp, index=True, overwrite='yes')
...
ref_edges_simp_joined.to_file(ref_edges_simplified_joined_fp, index=True, overwrite='yes')
